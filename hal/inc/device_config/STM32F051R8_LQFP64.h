...
/** PWM Channel configuration **/
	{//		Pin,			Port,	Pin_Source, 		Alternative_Function
		{	GPIO_Pin_8,		GPIOA,	GPIO_PinSource8,	GPIO_AF_2},
		{	GPIO_Pin_9,		GPIOA,	GPIO_PinSource9,	GPIO_AF_2},
		{	GPIO_Pin_10,	GPIOA,	GPIO_PinSource10,	GPIO_AF_2},
		{	GPIO_Pin_11,	GPIOA,	GPIO_PinSource11,	GPIO_AF_2},
	}
};
